...
npx claude-flow@alpha memory retrieve --namespace "swarm/[PROJECT]" --key "plan" || true
...
npx claude-flow@alpha memory retrieve --namespace "architecture/decisions" --key "*" || true
...
while ! npx claude-flow@alpha memory retrieve --namespace "swarm/module-a" --key "implementation-complete"; do sleep 10; done
while ! npx claude-flow@alpha memory retrieve --namespace "swarm/module-b" --key "implementation-complete"; do sleep 10; done
...
WAIT FOR ALL:
while ! npx claude-flow@alpha memory retrieve --namespace "swarm/architect" --key "complete"; do sleep 10; done
while ! npx claude-flow@alpha memory retrieve --namespace "swarm/coder" --key "implementation-complete"; do sleep 10; done
while ! npx claude-flow@alpha memory retrieve --namespace "swarm/tester" --key "tests-passing"; do sleep 10; done
