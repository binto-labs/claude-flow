...
Task("Backend Visualization Specialist",
  ...
  2. READ context from swarm memory:
     npx claude-flow@alpha memory retrieve --namespace "swarm/phase-2b" --key "plan"
     npx claude-flow@alpha memory retrieve --namespace "swarm/phase-2b" --key "api-contracts"
...
[Single Message - Parallel Agent Execution]:
  ...
  Task("Backend Caching Specialist",
    ...
    2. READ plan: npx claude-flow memory retrieve --namespace "swarm/phase-2b" --key "plan"
    3. TASKS:
