...
# WAIT for all agents
while ! npx claude-flow@alpha memory read --namespace "swarm/coder" --key "complete"; do sleep 10; done
while ! npx claude-flow@alpha memory read --namespace "swarm/tester" --key "complete"; do sleep 10; done
